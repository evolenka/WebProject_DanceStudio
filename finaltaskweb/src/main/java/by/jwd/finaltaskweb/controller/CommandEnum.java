...
public enum CommandEnum {
	...
	CONFIRMVISIT, CREATEVISIT, READALLSTYLE, READALLWEEKDAY, READALLLEVEL, READPLANNEDCLASSESBYTEACHER, MARKPRESENCE,
	CANCELMARKEDPRESENCE, READVISITSBYGROUPANDDATE, READGROUPSBYTEACHER, READVISITCOUNTBYTEACHERGROUPSANDPERIOD,
	EDITCLIENT, EDITTEACHER, EDITGROUP, DELETECLIENT, DELETETEACHER, DELETEGROUP, READGROUPFORENROLLMENTBYDATE,
	CREATECLASSES, READACTIVECLASSESBYDATE, CLOSEENROLLMENT, READVISITCOUNTBYGROUPSANDPERIOD,
	MEMBERSHIPSTATICSFORPERIOD, READCLIENTSBYDANCECLASS, WRONGCOMMAND
}