...
public class ReadAllMembershipTypesTest {
	...
	public void testReadAllTypes() throws DaoException {
		...
		List <MembershipType> actual = factory.getMembershipDao(transaction).readAllTypes();
